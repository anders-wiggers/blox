...
class ConfigReleaseModel:
    ...
    viewer_groups: Optional[List[str]] = field(default_factory=list, metadata={"description": "Groups that can view the application"})
    ...
    collaborator_groups: Optional[List[str]] = field(default_factory=list, metadata={"description": "Groups that can collaborate on the application"})